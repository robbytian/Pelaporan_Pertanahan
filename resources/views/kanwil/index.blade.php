...
<div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel tile">
        ...
        <hr>
        <div class="x_content">
            <h4>Ranking Kinerja Kantah</h4>

            <div class="widget_summary mt-3">
                <div class="w_left w_25">
                    <span>Kantor Pertanahan A</span>
                </div>
                <div class="w_center w_55">
                    <div class="progress">
                        <div class="progress-bar bg-green" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="1000" style="width: 100%;">
